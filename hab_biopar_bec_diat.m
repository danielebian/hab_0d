...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 BioPar.rSiNmin = 0.0685 / BioPar.rNC;	% max stoichiometric ratio for PN Si:N
 ...
 % Light dependence
 BioPar.aLightDi =  0.3 * BioPar.rNC/d2h;%0.0012;	% mmol N /(mg Chl W/m2 day)
 
 % Photoacclimation parameters
 BioPar.QNChlDi = 4; %8;			% mgChl/mmolN
 ...
 BioPar.beta =   0.0083;%0.1*BioPar.rNC;%0.0111;	% Max DA production stoichiomery (DA:N ratio for photo) 
 BioPar.gamma =  1.2308;%2.0; %1.0104;		% Exponent for DA production (in nutrient limitation term)
